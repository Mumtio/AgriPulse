...
public class MainActivity extends AppCompatActivity {
    ...
    private com.agripulse.cattlehealth.detection.MockAnimalDetector animalDetector;
    private com.agripulse.cattlehealth.detection.DetectionResult currentDetection = null;
    
    // Thermal ROI analyzer
    private com.agripulse.cattlehealth.thermal.ThermalROIAnalyzer roiAnalyzer;
    
    // Fever detector
    private com.agripulse.cattlehealth.health.FeverDetector feverDetector;
    
    // Scan storage
    private com.agripulse.cattlehealth.storage.ScanStorage scanStorage;
    
    // Thermal overlay view
    private com.agripulse.cattlehealth.ui.ThermalOverlayView overlayView;
    
    // Scan exporter
    private com.agripulse.cattlehealth.export.ScanExporter scanExporter;
    
    // Animal tracker
    private com.agripulse.cattlehealth.tracking.AnimalTracker animalTracker;
    
    // Batch scan manager
    private com.agripulse.cattlehealth.batch.BatchScanManager batchScanManager;
    
    // Location tracker
    private com.agripulse.cattlehealth.location.LocationTracker locationTracker;
    ...
    public interface ScanCallback {
        void onScanComplete(com.agripulse.cattlehealth.storage.ScanRecord result);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animalDetector = new com.agripulse.cattlehealth.detection.MockAnimalDetector();
        roiAnalyzer = new com.agripulse.cattlehealth.thermal.ThermalROIAnalyzer();
        feverDetector = new com.agripulse.cattlehealth.health.FeverDetector();
        scanStorage = new com.agripulse.cattlehealth.storage.ScanStorage(getApplicationContext());
        scanExporter = new com.agripulse.cattlehealth.export.ScanExporter(this);
        animalTracker = new com.agripulse.cattlehealth.tracking.AnimalTracker(this, scanStorage);
        batchScanManager = new com.agripulse.cattlehealth.batch.BatchScanManager();
        locationTracker = new com.agripulse.cattlehealth.location.LocationTracker(this);
        ...
        // DISABLED: We use CameraManager in ScanFragment instead
     ...
     */
    public com.agripulse.cattlehealth.tracking.AnimalTracker getAnimalTracker() {
        return animalTracker;
    }
    
    public com.agripulse.cattlehealth.storage.ScanStorage getScanStorage() {
        return scanStorage;
    }
    
    public com.agripulse.cattlehealth.export.ScanExporter getScanExporter() {
        return scanExporter;
    }
    
    public com.agripulse.cattlehealth.location.LocationTracker getLocationTracker() {
        return locationTracker;
    }
    
    public com.agripulse.cattlehealth.batch.BatchScanManager getBatchScanManager() {
    ...
    private void processScan(com.flir.thermalsdk.image.ThermalImage thermalImage) {
        try {
            ...
            com.agripulse.cattlehealth.detection.DetectionResult detection = 
            ...
            java.util.Map<String, com.agripulse.cattlehealth.thermal.ROITemperature> bodyPartTemps = 
                new java.util.HashMap<>();
            
            for (com.agripulse.cattlehealth.detection.Keypoint kp : detection.keypoints) {
                com.agripulse.cattlehealth.thermal.ROITemperature roiTemp = 
            ...
            // 4. Detect fever
            com.agripulse.cattlehealth.health.HealthStatus healthStatus = 
                feverDetector.detectFever(bodyPartTemps);
            
            ThermalLog.d(TAG, "Health status: " + healthStatus.toString());
            
            // 5. Get location
            com.agripulse.cattlehealth.location.LocationTracker.LocationData location = 
            ...
            java.util.Map<String, com.agripulse.cattlehealth.storage.ScanRecord.BodyPartData> bodyParts = 
                new java.util.HashMap<>();
            
            for (java.util.Map.Entry<String, com.agripulse.cattlehealth.thermal.ROITemperature> entry : 
                 bodyPartTemps.entrySet()) {
                com.agripulse.cattlehealth.thermal.ROITemperature roi = entry.getValue();
                bodyParts.put(entry.getKey(), 
                    new com.agripulse.cattlehealth.storage.ScanRecord.BodyPartData(
                        roi.bodyPart, roi.t95, roi.mean, roi.std, roi.sampleCount
                    ));
            }
            
            // 8. Create scan record
            com.agripulse.cattlehealth.storage.ScanRecord record = 
                new com.agripulse.cattlehealth.storage.ScanRecord(
            ...
            for (java.util.Map.Entry<String, com.agripulse.cattlehealth.thermal.ROITemperature> entry : 
                 bodyPartTemps.entrySet()) {
                com.agripulse.cattlehealth.thermal.ROITemperature roi = entry.getValue();
                record.rois.add(new com.agripulse.cattlehealth.storage.ScanRecord.ROIResult(
                    roi.bodyPart,
                    roi.mean - 273.15,  // Convert Kelvin to Celsius
                    roi.t95 - 273.15,
                    roi.std,
                    healthStatus.status.equals("SUSPECTED") ? 
                        com.agripulse.cattlehealth.storage.RiskStatus.SUSPECTED : 
                        com.agripulse.cattlehealth.storage.RiskStatus.NORMAL,
                    healthStatus.reason
                ));
            }
            ...
            record.reportText = com.agripulse.cattlehealth.export.ReportFormatter
                .formatTextReport(record);
            
            // 13. Callback to UI on main thread
            final com.agripulse.cattlehealth.storage.ScanRecord finalRecord = record;
